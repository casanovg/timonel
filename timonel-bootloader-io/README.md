...
This folder holds the same bootloader version and functionality as the "[Make version](/timonel-bootloader)", but as an experimental [PlatformIO](http://platformio.org) project to make building a bit more structured. Some upsides:
