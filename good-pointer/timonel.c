 ...
 *  ...........................................
 *  Version: 1.5 "Sandra" / 2020-06-06 KALARCHOMBA
...
void UsiTwiTransmitByte(MemPack*);
uint8_t UsiTwiReceiveByte(void);
inline static void UsiTwiDriverInit(MemPack*) __attribute__((always_inline));
inline static void TwiStartHandler(MemPack*) __attribute__((always_inline));
            ...
            if ((USIDR == 0) || ((USIDR >> 1) == TWI_ADDR)) {
                if (USIDR & 0x01) {     /* If data register low-order bit = 1, start the send data mode */
                    ...
                    for (uint8_t i = 0; i < command_size; i++) {        //  Call a function    >>
                        ...
                        command[i] = p_mem_pack->rx_buffer[p_mem_pack->rx_tail];                //  (command) ...      >>
                    }                                                   //                   >>
