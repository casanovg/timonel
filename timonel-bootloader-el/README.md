...
This folder holds the same bootloader version and functionality as the "[Make version](/timonel-bootloader)", except the USI-based, interrupt-free I2C driver lives here as an external library.
