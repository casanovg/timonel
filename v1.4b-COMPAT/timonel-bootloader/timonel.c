...
inline static void TwiDriverInit(void) __attribute__((always_inline));
...
//#pragma message "Prescaler dividing clock by 8, setting the CPU prescaler division factor to 1 ..."
    ...
    TwiDriverInit();                                 /* Initialize the TWI driver */
