...
In these examples, it's handy to have the chance of updating the AVRs firmware straight from the I2C master. But, so far (mid 2018), I haven't found an I2C bootloader that fits directly the Tiny85, addressing its limitations:
