...
This utility converts a .hex binary file into a .h file wich contains an byte array to be included in "timonel-twim-ss"

The AVR binary files should be placed into the "appl-flashable" folder. They can be generated using any editor + the avr-gcc toolchain, Atmel Studio 7 or the Arduino IDE. If you use Arduino IDE, the compiled .hex files are abit hard to find, use this instructions to find them: "https://arduino.stackexchange.com/questions/48431/how-to-get-the-firmware-hex-file-from-a-ino-file-containing-the-code".

Once that you have the desired .hex in the "appl-flashable" folder, just run

$ ./make-payload.sh appl-flashable/attiny_firmware.hex to converti it into a payload.
